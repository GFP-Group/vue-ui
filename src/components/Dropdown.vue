...
const triggerLabel = computed(() => props.label ?? 'Dropdown Button')
      ...
      <template v-for="item in items" :key="item.text">
        <button
          ...
          :class="[
            ...
            item.danger
              ? 'text-red-500 dark:text-red-400 hover:bg-gray-50 dark:hover:bg-white/3 hover:text-red-600 dark:hover:text-red-300'
              : 'text-body-color dark:text-dark-6 hover:bg-gray-50 dark:hover:bg-white/3 hover:text-black dark:hover:text-white',
          ]"
